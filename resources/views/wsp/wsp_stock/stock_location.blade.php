            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Stock Location Spareparts</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Stock Location</a></li>
                                <li class="breadcrumb-item active">Stock Location Spareparts</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <form id="formLocation">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="rakIdSelect" class="form-select" required>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btnAdd').click(function() {
                ...
                $('#rakIdSelect').val(null).trigger('change');
                $('#locationId').val('');
            ...
            $('#formLocation').submit(function(e) {
                ...
                if (!payload.mid_barang || !payload.rak_id) {
                    toastr.warning('MID Barang dan Lokasi Rak wajib diisi!');
                    return;
                }
