                ...
                <div class="collapse mt-3" id="advancedFilter">
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" id="filterNoReserved" placeholder="Cari No Reservasi">
                        </div>
                ...
                if (res.header && res.header.checklist_kondisi) {
                    ...
                    if (checklist && checklist.length > 0) {
                        ...
                        checklist.forEach(val => {
                            checkHtml += `<span class="badge bg-success"><i class="mdi mdi-check-circle me-1"></i>${val}</span>`;
                        });
