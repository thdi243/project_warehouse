    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function renderPagination(data) {
                ...
                html +=
                    `<button class="btn btn-sm btn-light border mx-1 page-btn" data-page="${current-1}" ${current==1?'disabled':''}>Prev</button>`;
                ...
                html +=
                    `<button class="btn btn-sm btn-light border mx-1 page-btn" data-page="${current+1}" ${current==last?'disabled':''}>Next</button>`;
