                    ...
                    <div class="col-12 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="card shadow-sm border-0 h-100 overflow-hidden hover-lift">
                            <div class="card-body text-center p-4 p-xl-5 d-flex flex-column">
                                ...
                                <p class="text-muted mb-4 flex-grow-1">Proses penambahan stok gula baru ke gudang menggunakan
                                    template file Excel.</p>

                                <button type="button" class="btn btn-primary btn-lg w-100 py-3 shadow-sm mt-auto"
                                    data-bs-toggle="modal" data-bs-target="#modalInbound">
                    ...
                    <div class="col-12 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                        <div class="card shadow-sm border-0 h-100 overflow-hidden hover-lift">
                            <div class="card-body text-center p-4 p-xl-5 d-flex flex-column">
                                ...
                                <p class="text-muted mb-4 flex-grow-1">Input stok non-gula (Garam, SKM, dll) secara manual per
                                    Nomor SPB.</p>

                                <button type="button" class="btn btn-info btn-lg w-100 py-3 text-white shadow-sm mt-auto"
                                    data-bs-toggle="modal" data-bs-target="#modalNonGula">
                    ...
                    <div class="col-12 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                        <div class="card shadow-sm border-0 h-100 overflow-hidden hover-lift">
                            <div class="card-body text-center p-4 p-xl-5 d-flex flex-column">
                                ...
                                <p class="text-muted mb-4 flex-grow-1">Pencatatan riwayat transfer stok (shrinkage) secara
                                    massal via Excel.</p>

                                <button type="button" class="btn btn-warning btn-lg w-100 py-3 shadow-sm mt-auto"
                                    data-bs-toggle="modal" data-bs-target="#modalOutbound">
            ...
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-body p-0">
                    ...
                    <ul class="nav nav-tabs-custom nav-justified" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active py-3 fw-bold" data-bs-toggle="tab" href="#manualInput"
                                role="tab">
                    ...
                    <div class="tab-content p-4">
                        <div class="tab-pane active" id="manualInput" role="tabpanel">
                            <form id="nonGulaForm" action="{{ route('wrm.inventory.non-gula-upload') }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                    <label class="form-label fw-bold">Material / Barang <span
                                            class="text-danger">*</span></label>
                                    <select name="mid_id" id="selectMidNonGula" class="form-control select2"
                                        required></select>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fw-bold">Nomor SPB <span class="text-danger">*</span></label>
                                    <input type="text" name="no_spb" class="form-control"
                                        placeholder="Contoh: 9000008999901" required>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label fw-bold">Total Qty (KG) <span
                                            class="text-danger">*</span></label>
                                    <input type="number" step="any" name="total_qty" class="form-control"
                                        placeholder="Masukkan total qty dalam KG" required>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label fw-bold">Expired Date <span
                                            class="text-muted small font-size-10">(Opsional)</span></label>
                        ...
                        <div class="tab-pane" id="excelUpload" role="tabpanel">
                            ...
                            <form id="nonGulaExcelForm" action="{{ route('wrm.inventory.non-gula-upload-excel') }}"
