...
@section('title', ' | Form Draft Outbound Raw Material')
                        ...
                        <div class="col-md-3 d-flex align-items-end">
                            <div class="form-check">
                                <input class="form-check-input checklist-item" type="checkbox"
                                    value="Barang yang dikirim dalam kondisi bersih dan utuh" id="cond1" checked>
                                <label class="form-check-label" for="cond1">Barang yang dikirim dalam kondisi bersih dan
                                    utuh</label>
                            </div>
                        </div>
                    </div>
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                Swal.fire({
                                    ...
                                    title: 'Berhasil',
                                    text: res.message ??
                                        'Draft Outbound berhasil disimpan',
                                    timer: 2000,
