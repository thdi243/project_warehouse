    ...
    <div class="page-content d-flex flex-column justify-content-center">
        <div class="container-fluid">
            ...
            <div class="page-header" data-aos="fade-down">
                <h3 class="fw-bold mb-1">🏷️ Stock Movement - WSP</h3>
                <p>Kelola dan pantau movement stok barang Anda dengan mudah</p>
            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay="100">
                    <div class="card card-animate feature-card stock-location">
                        <span class="stats-badge">
                            <i class="mdi mdi-check-outline me-1"></i> Active
                        </span>
                        <div class="card-body-custom">
                            ...
                            <h5>Incoming</h5>
                            <p>Kelola dan pantau barang masuk ke gudang secara detail</p>
                            <a href="{{ route('stock.move.incoming.index') }}"
                                class="btn btn-custom btn-purple-custom text-white">
                                <span>
                                    <i class="mdi mdi-download-circle me-2"></i>Kelola Incoming
                                </span>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay="150">
                    <div class="card card-animate feature-card stock-hand">
                        ...
                        <div class="card-body-custom">
                            ...
                            <h5>Outgoing</h5>
                            <p>Kelola dan pantau barang keluar secara real-time dan detail</p>
                            <a href="{{ route('stock.move.outgoing.index') }}"
                                class="btn btn-custom btn-primary-custom text-white">
                                <span>
                                    <i class="mdi mdi-truck-check me-2"></i>Kelola Outgoing
                                </span>
                            </a>
                        </div>
                    </div>
