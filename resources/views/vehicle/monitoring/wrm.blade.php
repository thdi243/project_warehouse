        ...
        $(document).ready(function() {
                        ...
                        if (allWrmData.length > 0) {
                            const followUps = allWrmData.filter(tx => {
                                return (tx.follow_up_timestamp || tx.follow_up_time) &&
                                    (tx.follow_up_target === 'WRM' || tx.follow_up_target ===
                                        'ALL' || tx.sloc === 'B006' || tx.target_sloc === 'B006'
                                        );
                            }).map(tx => ({
                                id: tx.id,
            ...
            $('#btnFollowUpTimbangan').on('click', function() {
                ...
                Swal.fire({
                    ...
                    html: `
                        <div class="text-start">
                            <p class="text-muted small mb-3">Lapor ke Timbangan jika ada truk yang <strong>sudah tiba di WRM</strong> namun belum terdaftar di sistem.</p>
                            <div class="mb-3">
                            ...
                            <div class="mb-2">
                                ...
                                <textarea id="fu_notes" class="form-control" rows="2" placeholder="Contoh: Truk sudah standby di area WRM, mohon segera input timbangan."></textarea>
                            </div>
                        </div>
                    `,
                    icon: 'info',
