            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0"><i class="mdi mdi-upload me-2"></i>Upload Stock On Hand WCP</h4>
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div
                                        ...
                                        <i class="mdi mdi-alert-circle me-1"></i> Data Master Barang kosong. Silakan isi <a
                                            href="{{ route('master.wcp.barang.index') }}"
            ...
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title text-white" id="uploadModalLabel">
                        <i class="mdi mdi-file-excel-outline me-1"></i> Upload File SOH WCP
                    </h5>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#uploadSOHForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('wcp.stock_opname.soh.import') }}",
                    type: "POST",
                    data: formData,
                    contentType: false,
                    processData: false,
            ...
            $('#btnDeleteAll').on('click', function() {
                ...
                Swal.fire({
                    ...
                    text: 'Seluruh data SOH WCP ' + (jenisSo === 'monthly' ? 'bulan ini' :
        ...
        function editSOH(id) {
            ...
            loadBarangOptions(() => {
                $.ajax({
                    url: `{{ route('wcp.stock_opname.soh.show', '') }}/${id}`,
                    type: 'GET',
                    success: function(res) {
        ...
        function deleteSOH(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `{{ route('wcp.stock_opname.soh.delete', '') }}/${id}`,
                        type: 'DELETE',
                        data: {
                            _token: "{{ csrf_token() }}"
                        },
