...
<html lang="id" class="h-full">
    ...
    <body
        ...
        <div class="max-w-md w-full text-center space-y-8">
            <!-- Icon Besar -->
            <div class="mx-auto">
                <i class="fas fa-lock text-red-500 text-9xl animate-pulse"></i>
            </div>

            <!-- Judul -->
            <h1 class="text-9xl font-black tracking-tight text-red-600 dark:text-red-400">403</h1>
            <h2 class="text-4xl md:text-5xl font-bold">Akses Ditolak</h2>
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4 mt-10">
                <a href="{{ url()->previous() }}"
                    class="inline-flex items-center px-8 py-4 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-xl shadow-lg transition transform hover:-translate-y-1">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-12">
                Jika ini kesalahan sistem, silakan hubungi Administrator.
            </p>
        </div>
