...
<html lang="id" class="h-full">
    ...
    <body
        ...
        <div class="max-w-md w-full text-center space-y-8">
            <!-- Icon Besar -->
            <div class="mx-auto">
                <i class="fas fa-user-lock text-yellow-500 text-9xl animate-pulse"></i>
            </div>

            <!-- Judul -->
            <h1 class="text-9xl font-black tracking-tight text-yellow-600 dark:text-yellow-400">401</h1>
            <h2 class="text-4xl md:text-5xl font-bold">Unauthorized</h2>

            <!-- Pesan -->
            <p class="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mt-6">
                {{ $exception->getMessage() ?: 'Anda belum terautentikasi atau sesi login Anda telah kadaluarsa.' }}
            </p>

            <!-- Tombol Aksi -->
            <div class="flex flex-col sm:flex-row justify-center gap-4 mt-10">
                <a href="{{ route('login') }}"
                    class="inline-flex items-center px-8 py-4 bg-yellow-600 hover:bg-yellow-700 text-white font-semibold rounded-xl shadow-lg transition transform hover:-translate-y-1">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-12">
                Jika Anda yakin sudah login, silakan refresh halaman atau hubungi Administrator.
            </p>
        </div>
