...
<html lang="id" class="h-full">
    ...
    <body
        ...
        <div class="max-w-md w-full text-center space-y-8">
            <div class="mx-auto">
                <i class="fas fa-bolt text-amber-500 text-9xl animate-pulse"></i>
            </div>

            <h1 class="text-9xl font-black tracking-tight text-amber-600 dark:text-amber-400">429</h1>
            <h2 class="text-4xl md:text-5xl font-bold">Terlalu Banyak Permintaan</h2>

            <p class="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mt-6">
                {{ $exception->getMessage() ?: 'Anda melakukan terlalu banyak permintaan dalam waktu singkat. Coba lagi nanti.' }}
            </p>

            <div class="flex flex-col sm:flex-row justify-center gap-4 mt-10">
                <a href="{{ url()->previous() }}"
                    class="inline-flex items-center px-8 py-4 bg-amber-600 hover:bg-amber-700 text-white font-semibold rounded-xl shadow-lg transition transform hover:-translate-y-1">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-12">
                Tunggu beberapa saat sebelum mencoba lagi untuk menghindari pembatasan.
            </p>
        </div>
