...
<html lang="id" class="h-full">
    ...
    <body
        ...
        <div class="max-w-md w-full text-center space-y-8">
            <div class="mx-auto">
                <i class="fas fa-tools text-indigo-500 text-9xl animate-pulse"></i>
            </div>

            <h1 class="text-9xl font-black tracking-tight text-indigo-600 dark:text-indigo-400">503</h1>
            <h2 class="text-4xl md:text-5xl font-bold">Layanan Sedang Dipelihara</h2>

            <p class="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mt-6">
                {{ $exception->getMessage() ?: 'Sistem sedang dalam pemeliharaan. Silakan kembali beberapa saat lagi.' }}
            </p>

            <div class="flex flex-col sm:flex-row justify-center gap-4 mt-10">
                <a href="{{ url('/dashboard') }}"
                    class="inline-flex items-center px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-xl shadow-lg transition transform hover:-translate-y-1">
                    <i class="fas fa-sync mr-2"></i> Cek Kembali
                </a>

                <a href="mailto:support@ptbas.com"
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-12">
                Kami sedang bekerja untuk meningkatkan layanan. Terima kasih atas pengertiannya.
            </p>
        </div>
