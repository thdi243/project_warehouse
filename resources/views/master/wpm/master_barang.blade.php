...
@section('title', '| Master Barang Packaging Material')
...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2">
                    <h5 class="mb-0">Master Barang Packaging Material (WPM)</h5>
            ...
            <form id="formBarang">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Form Master Barang WPM</h5>
    ...
    <div class="modal fade" id="modalUpload" tabindex="-1">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Upload Master Barang WPM</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#formBarang').submit(function(e) {
                ...
                if (id) {
                    url = `{{ url('/master/wpm/barang/update') }}/${id}`;
                    method = 'PUT';
                }
            ...
            $(document).on('click', '.btnHapus', function() {
                ...
                Swal.fire({
                    ...
                    $.ajax({
                        url: `{{ url('/master/wpm/barang/delete') }}/${id}`,
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
            ...
            $(document).on('click', '.btnRestore', function() {
                ...
                Swal.fire({
                    title: 'Pulihkan data?',
                    text: 'Master barang WPM ini akan diaktifkan kembali.',
                    icon: 'question',
                    showCancelButton: true,
                    ...
                    $.ajax({
                        url: `{{ url('/master/wpm/barang/restore') }}/${id}`,
                        type: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
            ...
            $(document).on('click', '.btnForceDelete', function() {
                ...
                Swal.fire({
                    ...
                    $.ajax({
                        url: `{{ url('/master/wpm/barang/force-delete') }}/${id}`,
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
