...
<script>
    $(document).ready(function() {
        ...
        function loadData(page = 1, search = '') {
            $.ajax({
                url: `/master/wrm/pallet/get-data?page=${page}`,
                method: 'GET',
                data: {
                    search: search
                },
        ...
        $('#palletForm').on('submit', function(e) {
            ...
            let id = $('#palletId').val();
            let url = id ? `/master/wrm/pallet/update/${id}` : `/master/wrm/pallet/store`;
        ...
        $(document).on('click', '.btnEdit', function() {
            ...
            let namaPallet = row.find('td:eq(1)').text();
        ...
        $(document).on('click', '.btnDelete', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `/master/wrm/pallet/destroy/${id}`,
                        method: 'DELETE',
                        data: {
