...
<script>
    $(document).ready(function() {
        ...
        function loadFeeAktif() {
            $.ajax({
                url: `/master/wrm/ikat-terpal/fee-aktif`,
                type: 'GET',
        ...
        function loadProdukAktif() {
            $.ajax({
                url: `/master/wrm/ikat-terpal/produk-aktif`,
                type: 'GET',
                success: function(data) {
        ...
        $('#form-fee').on('submit', function(e) {
            ...
            $.ajax({
                url: `/master/wrm/ikat-terpal/store/fee`,
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $('#form-produk').on('submit', function(e) {
            ...
            $.ajax({
                url: `/master/wrm/ikat-terpal/store/produk`,
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
