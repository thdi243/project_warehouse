            ...
            <form id="destinasiForm">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="destinasi-field" class="form-control" placeholder="Masukkan nama destinasi" required>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
                ...
                success: function(res) {
                    ...
                    if (res.status === true && items.length > 0) {
                        $.each(items, function(i, item) {
                            ...
                            const creator = item.created_by_user ? item.created_by_user.nama_lengkap : (item.created_by ? item.created_by.nama_lengkap : '-');
                        ...
                        container.append('<tr><td colspan="5" class="text-center">Data tidak ditemukan</td></tr>');
                    }
                },
                error: function(xhr) {
        ...
        function renderPagination(data) {
            ...
            let paginationHtml = '<nav aria-label="Page navigation"><ul class="pagination pagination-separated justify-content-center mb-0">';

            // Previous
            const prevDisabled = data.current_page === 1 ? 'disabled' : '';
            paginationHtml += `<li class="page-item ${prevDisabled}"><a class="page-link" href="#" data-page="${data.current_page - 1}">Previous</a></li>`;
            ...
            paginationHtml += `<li class="page-item ${nextDisabled}"><a class="page-link" href="#" data-page="${data.current_page + 1}">Next</a></li>`;
        ...
        $('#destinasiForm').submit(function(e) {
            e.preventDefault();
            var id = $('#id-field').val();
            var url = id ? "{{ url('wfg/master/destinasi/update') }}/" + id : "{{ route('wfg.master.destinasi.store') }}";
