...
<style>
    ...
    .kpi-card:hover { transform: translateY(-3px); box-shadow: 0 10px 25px -5px rgba(0,0,0,.08); }
    .kpi-icon-box { width:48px; height:48px; display:flex; align-items:center; justify-content:center; border-radius:10px; font-size:22px; }
    .dashboard-card { border-radius:12px; border:1px solid #e2e8f0; box-shadow:0 1px 3px rgba(0,0,0,.05); }
    ...
    .badge-approved  { background:#f5f3ff; color:#7c3aed; }
    .badge-loaded    { background:#fffbeb; color:#d97706; }
    .badge-verified  { background:#f0fdf4; color:#16a34a; }
    .badge-rejected  { background:#fef2f2; color:#dc2626; }
    .filter-tabs .nav-link { border-radius:8px; font-size:13px; font-weight:500; color:#64748b; padding:6px 14px; }
    .filter-tabs .nav-link.active { background:#6366f1; color:#fff; }
    .table-wavepick td { vertical-align: middle; font-size: 13px; }
    .table-wavepick th { font-size: 12px; font-weight: 600; color: #64748b; white-space: nowrap; }
    .bg-soft-indigo  { background:rgba(99,102,241,.1); color:#6366f1; }
    .bg-soft-green   { background:rgba(34,197,94,.1);  color:#16a34a; }
    .bg-soft-amber   { background:rgba(245,158,11,.1); color:#d97706; }
    .bg-soft-cyan    { background:rgba(6,182,212,.1);  color:#0891b2; }
    .bg-soft-violet  { background:rgba(168,85,247,.1); color:#7c3aed; }
    .bg-soft-red     { background:rgba(239,68,68,.1);  color:#dc2626; }
    .summary-stat { text-align:center; padding:10px 14px; border-radius:10px; background:#f8fafc; border:1px solid #e2e8f0; }
    .summary-stat .val { font-size:22px; font-weight:700; }
...
<div class="container-fluid">
    ...
    <div class="row mb-4 align-items-center">
        <div class="col-md-5 mb-3 mb-md-0">
            ...
            <p class="text-muted mb-0 small"><i class="bx bx-loader-circle me-1"></i>Monitoring real-time aktivitas loading & wavepick</p>
        </div>
        <div class="col-md-7">
    ...
    <div class="row g-3 mb-4">
        <div class="col-xl-2 col-md-4 col-6">
            <div class="card dashboard-card kpi-card h-100 p-3">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <h6 class="text-muted mb-0 small fw-semibold text-uppercase" style="font-size:10.5px">Total QTY Box</h6>
                </div>
        ...
        <div class="col-xl-2 col-md-4 col-6">
            <div class="card dashboard-card kpi-card h-100 p-3">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <h6 class="text-muted mb-0 small fw-semibold text-uppercase" style="font-size:10.5px">QTY Full Palet</h6>
                </div>
        ...
        <div class="col-xl-2 col-md-4 col-6">
            <div class="card dashboard-card kpi-card h-100 p-3">
                <div class="d-flex align-items-center mb-3">
                    <div class="kpi-icon-box bg-soft-amber me-3"><i class="mdi mdi-distribute-horizontal-left"></i></div>
                    <h6 class="text-muted mb-0 small fw-semibold text-uppercase" style="font-size:10.5px">QTY Receh</h6>
                </div>
        ...
        <div class="col-xl-2 col-md-4 col-6">
            <div class="card dashboard-card kpi-card h-100 p-3">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <h6 class="text-muted mb-0 small fw-semibold text-uppercase" style="font-size:10.5px">Orders Hari Ini</h6>
                </div>
        ...
        <div class="col-xl-2 col-md-4 col-6">
            <div class="card dashboard-card kpi-card h-100 p-3">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <h6 class="text-muted mb-0 small fw-semibold text-uppercase" style="font-size:10.5px">Verified</h6>
                </div>
        ...
        <div class="col-xl-2 col-md-4 col-6">
            <div class="card dashboard-card kpi-card h-100 p-3">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <h6 class="text-muted mb-0 small fw-semibold text-uppercase" style="font-size:10.5px">Pending</h6>
                </div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-xl-8">
            <div class="card dashboard-card h-100 p-3">
                <h6 class="fw-bold mb-0"><i class="bx bx-bar-chart-alt-2 me-2 text-primary"></i>Trend Loading Order & QTY Harian</h6>
                <div id="chartTrend" style="height:310px; width:100%"></div>
            </div>
        </div>
        <div class="col-xl-4">
            <div class="card dashboard-card h-100 p-3">
                <h6 class="fw-bold mb-0"><i class="bx bx-pie-chart-alt-2 me-2 text-primary"></i>Distribusi Status</h6>
        ...
        <div class="col-xl-8">
            <div class="card dashboard-card h-100 p-0 overflow-hidden">
                <div class="card-header p-3 border-bottom d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <h6 class="fw-bold mb-0"><i class="bx bx-list-ul me-2 text-primary"></i>List Wavepick Belum Diverifikasi</h6>
                    <ul class="nav filter-tabs gap-1 flex-nowrap" id="statusTabs">
                        <li class="nav-item"><a class="nav-link active" href="#" data-status="all">Semua</a></li>
                        <li class="nav-item"><a class="nav-link" href="#" data-status="draft">Draft</a></li>
                        <li class="nav-item"><a class="nav-link" href="#" data-status="submitted">Submitted</a></li>
                        <li class="nav-item"><a class="nav-link" href="#" data-status="approved">Approved</a></li>
                        <li class="nav-item"><a class="nav-link" href="#" data-status="loaded">Loaded</a></li>
                    </ul>
                </div>
...
const STATUS_COLOR = {
    draft:     '#94a3b8', submitted: '#3b82f6', approved: '#a855f7',
    loaded:    '#f59e0b'
};
...
function animCount($el, end) {
    $({ v: 0 }).animate({ v: end }, {
        ...
        step()  { $el.text(fmt(Math.round(this.v))); },
        complete() { $el.text(fmt(end)); }
    });
}
...
// ---- Init date defaults ----
$(function () {
    const today = new Date(), s = new Date();
    s.setDate(today.getDate() - 29);
    $('#filterStart').val(s.toISOString().split('T')[0]);
    $('#filterEnd').val(today.toISOString().split('T')[0]);

    Highcharts.setOptions({ lang: { thousandsSep: '.' }, credits: { enabled: false },
    ...
    function loadKpi() {
        $.get(API.kpi, getParams(), function (r) {
            ...
            $.each(d.status_counts, function(s, v) {
                if (!v) return;
                pills += `<span class="status-badge badge-${s}">${STATUS_LABEL[s] || s}: <b>${v}</b></span>`;
            });
    ...
    function loadWavepick(status) {
        const params = Object.assign(getParams(), { status });
        $('#wavepickTable').html('<tr><td colspan="10" class="text-center py-3 text-muted"><i class="bx bx-loader bx-spin"></i> Loading...</td></tr>');
        $.get(API.wavepick, params, function (r) {
            if (!r.status || !r.data.length) {
                $('#wavepickTable').html('<tr><td colspan="10" class="text-center py-4 text-muted">Tidak ada data</td></tr>');
                return;
            }
            let html = '';
        ...
        $.get(API.trend, getParams(), function (r) {
            ...
            if (!trendChart) {
                trendChart = Highcharts.chart('chartTrend', {
                    chart: { type: 'column', backgroundColor: 'transparent', marginTop: 30 },
                    title: { text: null },
                    xAxis: { categories: d.categories, crosshair: true, tickWidth: 0, lineColor: '#e2e8f0' },
                    yAxis: [
                        { min: 0, title: { text: 'QTY (Box/Pcs)', style: { color: '#64748b', fontSize: '11px' } }, gridLineColor: '#f1f5f9' },
                        { min: 0, title: { text: 'Orders', style: { color: '#6366f1', fontSize: '11px' } }, opposite: true, gridLineWidth: 0 }
                    ],
                    tooltip: { shared: true },
                    legend: { verticalAlign: 'top', itemStyle: { fontWeight: 'normal', color: '#64748b' } },
                    plotOptions: {
                        column: { borderRadius: 4, groupPadding: 0.15 },
                        spline: { marker: { radius: 3 }, lineWidth: 2.5 }
                    },
                    series: d.series
                });
            } else {
                trendChart.xAxis[0].setCategories(d.categories, false);
                d.series.forEach((s, i) => { trendChart.series[i].setData(s.data, false); });
                trendChart.redraw();
            }
        });
    }
        ...
        $.get(API.status, getParams(), function (r) {
            ...
            if (!statusChart) {
                statusChart = Highcharts.chart('chartStatus', {
                    ...
                    plotOptions: {
                        pie: {
                            innerSize: '60%', borderWidth: 2, borderColor: '#fff',
                            dataLabels: { enabled: true, format: '<b>{point.name}</b>', style: { fontWeight: 'normal' } }
                        }
                    },
                    series: [{ name: 'Orders', colorByPoint: true, data: r.data }]
                });
            } else {
        ...
        $.get(API.destination, getParams(), function (r) {
            ...
            if (!destChart) {
                destChart = Highcharts.chart('chartDestination', {
                    ...
                    title: { text: null },
                    xAxis: { categories: d.categories, gridLineWidth: 0, lineColor: '#e2e8f0' },
                    yAxis: { min: 0, title: { text: null }, gridLineColor: '#f1f5f9' },
                    tooltip: { valueSuffix: ' LO' },
                    legend: { enabled: false },
                    plotOptions: { bar: { borderRadius: 5, dataLabels: { enabled: true, style: { fontWeight: 'normal' } } } },
                    series: d.series
                });
            } else {
                destChart.xAxis[0].setCategories(d.categories, false);
                d.series.forEach((s, i) => { destChart.series[i].setData(s.data, false); });
                destChart.redraw();
            }
        });
    }
